...
public class MainFrame extends JFrame {
    ...
    private MummyMazeAgent agent = new MummyMazeAgent(new MummyMazeState(new char[13][13], 0, 0, 0, 0,new LinkedList<>(), new LinkedList<>()));
    ...
    public void buttonShowSolution_ActionPerformed(ActionEvent e) {
        ...
        SwingWorker worker = new SwingWorker<Void, Void>() {
            @Override
            public Void doInBackground() throws IOException, ClassNotFoundException {
                //mostrar a lista dos estados
